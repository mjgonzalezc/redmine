...
--
-- Table structure for table `configuration_item_relations`
--

DROP TABLE IF EXISTS `configuration_item_relations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `configuration_item_relations`
--

LOCK TABLES `configuration_item_relations` WRITE;
/*!40000 ALTER TABLE `configuration_item_relations` DISABLE KEYS */;
/*!40000 ALTER TABLE `configuration_item_relations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `configuration_items` (
  ...
  `description` text,
  `cmdb_identifier` varchar(255) DEFAULT NULL,
...
INSERT INTO `configuration_items` VALUES (1,'uno','servidor','www.google.es','Una descripcion','1',1);
...
INSERT INTO `custom_fields` VALUES (1,'IssueCustomField','owner-email','string',NULL,'',NULL,NULL,0,0,0,1,0,NULL,1,1,0,NULL,NULL),(2,'ProjectCustomField','helpdesk-first-reply','text',NULL,'',NULL,NULL,0,0,0,2,0,NULL,1,0,0,NULL,NULL),(3,'ProjectCustomField','helpdesk-email-footer','text',NULL,'',NULL,NULL,0,0,0,3,0,NULL,1,0,0,NULL,NULL),(4,'ProjectCustomField','helpdesk-sender-email','string',NULL,'',NULL,NULL,0,0,0,4,0,NULL,1,1,0,NULL,NULL),(5,'ProjectCustomField','helpdesk-send-to-owner-default','bool',NULL,'',NULL,NULL,0,0,0,5,0,NULL,1,0,0,NULL,NULL),(6,'IssueCustomField','copy-to','string',NULL,'',NULL,NULL,0,0,0,6,0,NULL,1,1,0,NULL,NULL),(7,'ProjectCustomField','cc-handling','bool',NULL,'',NULL,NULL,0,0,0,7,0,NULL,1,1,0,NULL,NULL);
...
INSERT INTO `custom_fields_trackers` VALUES (1,1),(1,2),(1,3),(6,1),(6,2),(6,3);
...
INSERT INTO `email_addresses` VALUES (1,1,'admin@example.net',1,1,'2018-11-27 09:32:52','2018-11-27 09:32:52'),(2,5,'usuario1@email-prueba.es',1,1,'2018-11-28 10:40:11','2018-11-28 10:40:11'),(3,6,'usuario2@email-prueba.es',1,1,'2018-11-28 10:40:22','2018-11-28 10:40:22'),(4,7,'usuario3@email-prueba.es',1,1,'2018-11-28 10:40:33','2018-11-28 10:40:33'),(5,8,'usuario4@email-prueba.es',1,1,'2018-11-28 10:40:44','2018-11-28 10:40:44');
...
INSERT INTO `enabled_modules` VALUES (1,1,'issue_tracking'),(2,1,'time_tracking'),(6,1,'wiki'),(11,1,'monitoring_controlling_project'),(13,1,'gantt');
...
INSERT INTO `enumerations` VALUES (1,'Baja',1,0,'IssuePriority',1,NULL,NULL,'lowest'),(2,'Normal',2,1,'IssuePriority',1,NULL,NULL,'default'),(3,'Alta',3,0,'IssuePriority',1,NULL,NULL,'high3'),(4,'Urgente',4,0,'IssuePriority',1,NULL,NULL,'high2'),(5,'Inmediata',5,0,'IssuePriority',1,NULL,NULL,'highest'),(6,'Documentación de usuario',1,0,'DocumentCategory',1,NULL,NULL,NULL),(7,'Documentación técnica',2,0,'DocumentCategory',1,NULL,NULL,NULL),(8,'Diseño',1,0,'TimeEntryActivity',1,NULL,NULL,NULL),(9,'Desarrollo',2,0,'TimeEntryActivity',1,NULL,NULL,NULL);
...
INSERT INTO `issue_statuses` VALUES (1,'Nueva',0,1,NULL),(2,'En curso',0,2,NULL),(3,'Resuelta',0,3,NULL),(4,'Comentarios',0,4,NULL),(5,'Cerrada',1,5,NULL),(6,'Rechazada',1,6,NULL);
...
INSERT INTO `issues` VALUES (1,2,1,'Tarea 1','Ut ac tristique metus. Aenean cursus vitae mi vel accumsan. Suspendisse potenti. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nullam nec molestie tortor. Nunc augue nulla, lobortis eu risus sed, tempus lobortis massa. Donec faucibus purus quam, nec sodales quam porta sed. Nunc ultricies elit elit, nec dignissim odio posuere eu. Etiam fermentum varius varius. Sed risus risus, dictum at quam eget, pharetra aliquam magna. Suspendisse potenti. Quisque laoreet viverra quam, vitae vehicula metus. Ut euismod sagittis leo, in semper lacus. Proin at ex vel lorem maximus commodo interdum viverra enim. Nullam faucibus a sapien nec tempus.',NULL,NULL,1,5,2,NULL,5,1,'2018-11-28 10:45:16','2018-11-28 13:13:01','2018-11-28',0,NULL,NULL,1,1,2,0,NULL),(2,2,1,'Nueva tarea','Una descripción',NULL,NULL,1,NULL,2,NULL,1,0,'2018-11-28 12:51:26','2018-11-28 12:51:26','2018-11-28',0,NULL,NULL,2,1,2,0,NULL),(3,2,1,'Otra peticion','adsfadsf',NULL,NULL,1,1,2,NULL,1,1,'2018-11-28 13:18:30','2018-11-28 13:21:00','2018-11-28',0,NULL,NULL,3,1,2,0,NULL);
...
CREATE TABLE `journals` (
  ...
  `send_to_owner` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `journals` VALUES (1,1,'Issue',1,'Una nota','2018-11-28 13:13:01',0,0),(2,3,'Issue',1,'khkljhkl','2018-11-28 13:21:00',0,0);
...
INSERT INTO `member_roles` VALUES (1,1,3,NULL),(2,1,4,NULL),(3,1,5,NULL),(4,2,3,NULL);
...
INSERT INTO `members` VALUES (1,1,1,'2018-11-28 10:33:35',0),(2,5,1,'2018-11-28 10:42:05',0);
...
INSERT INTO `projects` VALUES (1,'Proyecto 1','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi et vestibulum ipsum. Nulla urna ex, mattis sagittis egestas non, rutrum eu nunc. Nullam feugiat purus non metus efficitur, vitae accumsan leo facilisis. Aliquam a aliquet elit. Nulla vitae posuere nisl. Curabitur luctus eget ex eu egestas. Pellentesque tincidunt dui pellentesque, rhoncus sapien malesuada, ullamcorper tellus. Integer placerat et neque ac pharetra. Donec ut erat a massa auctor faucibus.','',1,NULL,'2018-11-28 10:32:50','2018-11-28 10:32:50','proyecto-1',1,1,2,0,NULL,NULL);
...
INSERT INTO `settings` VALUES (1,'default_projects_public','1','2018-11-28 10:32:01'),(2,'default_projects_modules','---\n- issue_tracking\n- time_tracking\n- news\n- documents\n- files\n- wiki\n- repository\n- monitoring_controlling_project\n','2018-11-28 10:34:25'),(3,'default_projects_tracker_ids','--- []\n','2018-11-28 10:32:01'),(4,'sequential_project_identifiers','0','2018-11-28 10:32:01'),(5,'ui_theme','','2018-11-28 10:34:11'),(6,'default_language','es','2018-11-28 10:34:11'),(7,'force_default_language_for_anonymous','0','2018-11-28 10:34:11'),(8,'force_default_language_for_loggedin','0','2018-11-28 10:34:11'),(9,'start_of_week','','2018-11-28 10:34:11'),(10,'date_format','','2018-11-28 10:34:11'),(11,'time_format','','2018-11-28 10:34:11'),(12,'timespan_format','decimal','2018-11-28 10:34:11'),(13,'user_format','firstname_lastname','2018-11-28 10:34:11'),(14,'gravatar_enabled','0','2018-11-28 10:34:11'),(15,'gravatar_default','','2018-11-28 10:34:12'),(16,'thumbnails_enabled','0','2018-11-28 10:34:12'),(17,'thumbnails_size','100','2018-11-28 10:34:12'),(18,'new_item_menu_tab','2','2018-11-28 10:34:12');
...
INSERT INTO `tokens` VALUES (2,1,'session','ab4697282bb34e97822bbca30a836758e693fc90','2018-11-27 09:34:57','2018-11-27 09:35:51'),(3,1,'feeds','ec5cf4fda249b51c7a5becff09e7552c0fbfcdcc','2018-11-27 09:35:22','2018-11-27 09:35:22'),(6,5,'feeds','904e9c9407dc1aad9d5172ca41d56cf15f29963d','2018-11-28 10:42:25','2018-11-28 10:42:25'),(7,1,'session','0f57e89b5968de71f3e2520521dcf827b9306e82','2018-11-28 10:45:47','2018-11-28 10:53:36'),(10,1,'session','3097a4c1b8d63c6d7cf28ffb189ba4a8dd78b3c8','2018-11-28 13:15:14','2018-11-28 16:14:47'),(11,1,'session','4287b45523bc5a47c94bcd00921f8f49c1c59223','2018-11-29 09:21:31','2018-11-29 13:15:23');
...
INSERT INTO `trackers` VALUES (1,'Errores',1,1,0,0,1),(2,'Tareas',1,2,1,0,1),(3,'Soporte',0,3,0,0,1);
...
INSERT INTO `users` VALUES (1,'admin','c88ad885951fce357a10e19900d12983e49e910f','Redmine','Admin',1,1,'2018-11-29 09:21:31','',NULL,'2018-11-27 09:32:39','2018-11-27 09:34:57','User',NULL,'all','0bd4aa9bba6732d6bd6d3f70baa9f5b1',0,'2018-11-27 09:34:57'),(2,'','','','Anonymous users',0,1,NULL,'',NULL,'2018-11-27 09:32:52','2018-11-27 09:32:52','GroupAnonymous',NULL,'',NULL,0,NULL),(3,'','','','Non member users',0,1,NULL,'',NULL,'2018-11-27 09:32:52','2018-11-27 09:32:52','GroupNonMember',NULL,'',NULL,0,NULL),(4,'','','','Anonymous',0,0,NULL,'',NULL,'2018-11-27 09:34:31','2018-11-27 09:34:31','AnonymousUser',NULL,'only_my_events',NULL,0,NULL),(5,'usuario1','69a73d7e647f6484eaf56b5e86cbe3bb58cba7c4','Usuario 1','Apellido',0,1,'2018-11-28 13:13:51','es',NULL,'2018-11-28 10:40:11','2018-11-28 10:40:11','User',NULL,'only_my_events','386f04f1bd04f117969f03ed86ce560f',0,'2018-11-28 10:40:11'),(6,'usuario2','b54ee1b0c60aaab4d0e02ef431545fe2e98f684e','Usuario 2','Apellido',0,1,NULL,'es',NULL,'2018-11-28 10:40:22','2018-11-28 10:40:22','User',NULL,'only_my_events','8a1d0b77c601a3ae442aee83091a9aa6',0,'2018-11-28 10:40:22'),(7,'usuario3','e565b647b41b45b16e2c45e8bde2411e4a641d8f','Usuario 3','Apellido',0,1,NULL,'es',NULL,'2018-11-28 10:40:33','2018-11-28 10:40:33','User',NULL,'only_my_events','cd727a4fe75245a84e1d475e36fe8b88',0,'2018-11-28 10:40:33'),(8,'usuario4','ea2e404606245931c6ca1141a7bf195c13dee12e','Usuario 4','Apellido',0,1,NULL,'es',NULL,'2018-11-28 10:40:44','2018-11-28 10:40:44','User',NULL,'only_my_events','0e733f4724ef111f37673467ab7097cc',0,'2018-11-28 10:40:44');
...
-- Dump completed on 2018-12-12 11:02:06
